...
function init_charts() {
    ...
    if ($('#mybarChartOne').length) {
        ...
        let ctx = document.getElementById("mybarChartOne");
        let mybarChartOne = new Chart(ctx, {
            type: 'bar',
            data: {
                labels: ["January", "February", "March", "April", "May", "June", "July"],
                datasets: [{
    ...
    // My Bar Chart Two
    if ($('#mybarChartTwo').length) {

        let ctx = document.getElementById("mybarChartTwo");
        let mybarChartTwo = new Chart(ctx, {
            type: 'bar',
            data: {
                labels: ["January", "February", "March", "April", "May", "June", "July"],
                datasets: [{
    ...
    // My Bar Chart Three
    if ($('#mybarChartThree').length) {

        let ctx = document.getElementById("mybarChartThree");
        let mybarChartThree = new Chart(ctx, {
            type: 'bar',
            data: {
                labels: ["January", "February", "March", "April", "May", "June", "July"],
                datasets: [{
    ...
    // My Bar Chart Four
    if ($('#mybarChartFour').length) {

        let ctx = document.getElementById("mybarChartFour");
        let mybarChartFour = new Chart(ctx, {
            type: 'bar',
            data: {
                labels: ["January", "February", "March", "April", "May", "June", "July"],
                datasets: [{
